...
t, d = 0, playingTrackIndex = 0, playingTrackLesson=0, autoNext = false, firstLesson = 1, lastLessonChapterI = 25, lastLesson = 50, jsonContent = null;
...
function addLessonIndex(lessonIndex) {
    ...
    menu.innerHTML =   '<button type="button" class="btn btn-primary dropdown-toggle btn-noneBorder" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'+ formatNumber(lessonIndex) + '</button>';
